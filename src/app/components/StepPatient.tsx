...
import { Check, CheckCircle2, User, HeartPulse, Stethoscope, ChevronDown, ShieldCheck, FileText, Upload, Activity, ClipboardList, Camera, Trash2, FolderSync, ScanLine, CloudUpload, Loader2, X, RotateCcw, AlertTriangle, Plus, Search, Sparkles, Clock, Send } from "lucide-react";
...
import { MOCK_PFLEGEPLANUNGEN, MOCK_KLV_VERORDNUNGEN, MOCK_ARZT_DIAGNOSEN } from "../../lib/mocks/klinische-artefakte-mock";
...
import { hProWoche, istPeriodisch, einheitLabel, werLabel, berechneSummen, getSimultanPartner } from "../../lib/klv/berechnung";
