...
export interface Patient {
  ...
  krankenkasse: string;
  /* ── Abrechnung (im Onboarding erfasst, für generalInvoice) ── */
  /** SP-03: Nummer auf der Versichertenkarte */
  kartennummer: string;
  /** SP-03: BAG-Nr. der Kasse */
  bagNr: string;
  /* ── Notfallkontakt (eigener Sachverhalt, nicht der betreuende Angehörige) ── */
...
export const patients: Patient[] = [
  {
    ...
    bagNr: "0350",
    notfallkontaktName: "Vera Steiner",
    notfallkontaktTelefon: "+41 44 312 55 01",
    notfallkontaktBeziehung: "Ehefrau",
    status: "aktiv",
    kanton: "ZH",
    schweregrad: "mittel",
  ...
  },
  {
    ...
    bagNr: "0271",
    notfallkontaktName: "Beatrice Hübscher-Wiederkehr",
    notfallkontaktTelefon: "+41 44 320 18 44",
    notfallkontaktBeziehung: "Tochter",
    status: "aktiv",
    kanton: "ZH",
    schweregrad: "leicht",
  ...
  },
  {
    ...
    bagNr: "0580",
    notfallkontaktName: "Arben Rexhepi",
    notfallkontaktTelefon: "+41 44 555 22 10",
    notfallkontaktBeziehung: "Sohn",
    status: "aktiv",
    kanton: "ZH",
    schweregrad: "schwer",
  ...
  },
  {
    ...
    bagNr: "0350",
    notfallkontaktName: "Yusuf Kaya",
    notfallkontaktTelefon: "+41 44 310 77 33",
    notfallkontaktBeziehung: "Ehemann",
    status: "gekuendigt",
    kanton: "AG",
    schweregrad: "mittel",
  ...
  },
  {
    ...
    bagNr: "0700",
    notfallkontaktName: "Erika Huber",
    notfallkontaktTelefon: "+41 44 299 33 15",
    notfallkontaktBeziehung: "Schwester",
  ...
  },
  {
    ...
    bagNr: "0610",
    notfallkontaktName: "Marta Da Silva",
    notfallkontaktTelefon: "+41 44 401 12 88",
    notfallkontaktBeziehung: "Tochter",
    status: "aktiv",
    kanton: "SG",
    schweregrad: "leicht",
  ...
  },
  {
    ...
    bagNr: "0780",
    notfallkontaktName: "Heidi Bösiger",
    notfallkontaktTelefon: "+41 44 488 91 02",
    notfallkontaktBeziehung: "Tochter",
    status: "aktiv",
    kanton: "ZH",
    schweregrad: "mittel",
  ...
  },
  {
    ...
    bagNr: "0376",
    notfallkontaktName: "Lucia Ferrari",
    notfallkontaktTelefon: "+41 44 677 45 20",
    notfallkontaktBeziehung: "Ehefrau",
    status: "nicht_abrechenbar",
    kanton: "BE",
  ...
  },
  {
    ...
    bagNr: "0271",
    notfallkontaktName: "Karl Zimmermann",
    notfallkontaktTelefon: "+41 44 555 88 43",
    notfallkontaktBeziehung: "Ehemann",
    status: "aktiv",
    kanton: "ZH",
    schweregrad: "leicht",
  ...
  },
  {
    ...
    bagNr: "0240",
    notfallkontaktName: "Margrit Keller",
    notfallkontaktTelefon: "+41 44 210 63 77",
    notfallkontaktBeziehung: "Ehefrau",
    status: "aktiv",
    kanton: "LU",
    schweregrad: "mittel",
