...
export const serviceTickets: ServiceTicket[] = [
  {
    ...
    betroffenePerson: { name: "Ayşe Yılmaz", initialen: "AY" }, erstelltVon: P.LB, erstellt: "2026-08-03", faellig: "2026-08-04", status: "offen", verantwortlich: P.LB, prioritaet: "hoch", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Emine Kaya", initialen: "EK" }, erstelltVon: P.KM, erstellt: "2026-08-02", faellig: "2026-08-11", status: "in_bearbeitung", verantwortlich: P.KM, prioritaet: "mittel", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Joaquim Da Silva", initialen: "JD" }, erstelltVon: P.LB, erstellt: "2026-08-03", faellig: "2026-08-05", status: "offen", verantwortlich: P.SW, prioritaet: "hoch", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Carlos Silva", initialen: "CS" }, erstelltVon: P.KM, erstellt: "2026-08-02", faellig: "2026-08-07", status: "offen", verantwortlich: P.KM, prioritaet: "mittel", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Gertrud Zimmermann", initialen: "GZ" }, erstelltVon: P.MK, erstellt: "2026-08-01", faellig: "2026-08-21", status: "erledigt", verantwortlich: P.MK, prioritaet: "niedrig", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Werner Keller", initialen: "WK" }, erstelltVon: P.LB, erstellt: "2026-08-03", faellig: "2026-08-06", status: "offen", verantwortlich: { name: "Nicht zugewiesen", initialen: "" }, prioritaet: "hoch", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Marie-Louise Hübscher-Wiederkehr", initialen: "MH" }, erstelltVon: P.MK, erstellt: "2026-08-03", faellig: "2026-08-07", status: "offen", verantwortlich: P.SW, prioritaet: "mittel", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Monika Brunner", initialen: "MB" }, erstelltVon: P.LB, erstellt: "2026-08-03", faellig: "2026-08-10", status: "offen", verantwortlich: P.LB, prioritaet: "mittel", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Elisabeth Hofer", initialen: "EH" }, erstelltVon: P.SW, erstellt: "2026-07-30", faellig: "2026-08-12", status: "in_bearbeitung", verantwortlich: P.SW, prioritaet: "mittel", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Anna Bösiger", initialen: "AB" }, erstelltVon: P.TS, erstellt: "2026-08-02", faellig: "2026-08-06", status: "in_bearbeitung", verantwortlich: P.SW, prioritaet: "hoch", kommentare: [],
  },
  {
    ...
    betroffenePerson: { name: "Jakob Weber", initialen: "JW" }, erstelltVon: P.MK, erstellt: "2026-08-03", faellig: "2026-08-18", status: "offen", verantwortlich: P.MK, prioritaet: "niedrig", kommentare: [],
  },
];
